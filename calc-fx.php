...
if (isset($_POST['ID_BRAND'], $_POST['ID_PRODUCT'], $_POST['ID_DURATION'], $_POST['ID_AMOUNT'], $_POST['ID_APPORT'])) {
    ...
    list($rate, $TXFD, $ADI, $Diff) = fetchData($brand, $product, $number, $DG);
...
function fetchData($brand, $product, $duration, $DG) {
    global $conn;
    $query = "SELECT TAUX, TXFD, ADI, Dif FROM SLF_TARIFICATION WHERE MARQUE = '$brand' AND PRODUIT = '$product' AND DUREE = '$duration' AND APPORT ='$DG' ";
