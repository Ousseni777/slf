                    ...
                    <table class="table table-bordered" id="myTable" >
                        ...
                        <tbody>
                            ...
                            if (isset($_SESSION['seller_id'])) {
                                ...
                                $query_user = "SELECT * FROM `slf_user_client` WHERE 1";
                                    ...
                                    if (count($users) > 0) {
                                        foreach ($users as $data) {
                                            ...
                                            if ($result_credit->num_rows > 0) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td scope="row"><?php echo '<a href="./detail?credit_id='. $credit["credit_id"] .' "> <i class="bi bi-info-circle"></i> '. $credit["credit_id"] . '</a>' ?> </td>
                                                    <td>
                                                        <?php echo $day ?>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <a href="./action/dialog?action=delete&id=<?php echo $credit["credit_id"] ?>" type="button" class="btn btn-danger">
                                                            <i class="bi bi-trash"></i> Suprimer

                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="./action/dialog?action=restart&id=<?php echo $credit["credit_id"] ?>" type="button" class="btn btn-primary"><i class="bi bi-pencil-square"></i>
                                                            Reprendre
                                                        </a>
                                                    </td>
