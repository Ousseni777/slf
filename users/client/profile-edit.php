...
<div class="tab-pane fade pt-3" id="profile-pieces">
    ...
    <div class="card" id="profile-pieces-edit">
        <div class="card-body row">
            ...
            <div class="col-lg-4 justificatifs">
                <div class="portfolio-wrap col-8 form-control">
                    <img id="preview-inputImageCIN" src="users/agency/images/<?php echo $client["cin_piece"] ?>"
                        class="pieces img-fluid" alt="">
                    <div class="portfolio-links">
                        <a href="users/agency/images/<?php echo $client["cin_piece"] ?>" class="portfolio-lightbox"><i
            ...
            <div class="col-lg-4 justificatifs">
                <div class="portfolio-wrap col-8 form-control">
                    <img id="preview-inputImageRib" src="users/agency/images/<?php echo $client["rib_piece"] ?>"
                        class="pieces img-fluid" alt="">
                    <div class="portfolio-links">
                        <a href="users/agency/images/<?php echo $client["rib_piece"] ?>" class="portfolio-lightbox"><i
                                class="bi bi-plus"></i></a>
            ...
            <div class="col-lg-4 justificatifs">
                <div class="portfolio-wrap col-8 form-control">
                    <img id="preview-inputImageAdress" src="users/agency/images/<?php echo $client["adress_piece"] ?>"
                        class="pieces img-fluid" alt="">
                    <div class="portfolio-links">
        ...
        <div class="col-lg-12">
            <button type="submit" class="btn btn-outline-success btn-send-infos-client" name="">Sauvegarder les
