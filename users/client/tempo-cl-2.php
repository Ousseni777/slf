                ...
                <div class="card">
                    <div class="card-body pt-3">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-overview">suivre
                                    mes
                                    demandes</button>
                            </li>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="profile-new card" id="profile-new">
                                <div class="card-body">
                            ...
                            <div class="tab-pane fade pt-3" id="profile-pieces">
                                ...
                                <div class="row mb-3" id="profile-pieces-new">
                                    ...
                                    <div class="col-md-8 col-lg-3">
                                        <div class="portfolio-wrap col-8 form-control">
                                            ...
                                            <img id="preview-inputImageCIN" class="mt-3"
                                                src="users/client/images/cin.jpg" style="width: 130px; height: 100px;"
                                                alt="Profile">

                                        </div>
                                        <label class="btn btn-outline-primary" for="inputImageCIN"><i
                                                class="bi bi-upload"></i> Charger le CIN</label>
                                    ...
                                    <div class="col-md-8 col-lg-3">
                                        <div class="portfolio-wrap col-8 form-control">
                                            ...
                                            <img id="preview-inputImageRib" class="mt-3"
                                                src="users/client/images/rib.png" style="width: 130px; height: 100px;"
                                                alt="Profile">

                                        </div>

                                        <label class="btn btn-outline-primary" for="inputImageRib"><i
                                                class="bi bi-upload"></i> Charger le RIB</label>
                                        <input type="file" name="yourRIB"
                                            accept="image/x-png,image/gif,image/jpeg,image/jpg"
                                            class="form-control inputImage" id="inputImageRib" required>
                                    ...
                                    <div class="col-md-8 col-lg-3">
                                        ...
                                        <label class="btn btn-outline-primary" for="inputImageAdress"><i
                                                class="bi bi-upload"></i> Charger l'adresse</label>
                                    ...
                                    <div class="col-lg-8 mt-5">
                                        <button type="submit" class="btn btn-outline-success btn-send-infos-client"
                                            name="">Envoyer les justificatifs</button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="success-text" id="success-infos">
            <div class="alert alert-success" role="alert" style="text-align:center;">
                ...
                <p>Vos données personnelles ont été envoyées avec succès, merci de nous faire part les justificatifs !
                </p>
            </div>
        </div>
                    ...
                    <section class="section">
                        <form action="#" enctype="multipart/form-data" id="formInfos" method="post">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary btn-send" id="" name="infos_pieces">Envoyer
                                    la
                                    demande</button>
                            </div>
                        </form>
...
<div class="modal fade" id="modalPieces" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-dialog-scrollable">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row d-flex flex-column align-items-center justify-content-center">
                    <div class="col-md-8 col-lg-6 row">
                        <!-- <span>CIN / Carte séjour</span> -->
                        <div class="portfolio-wrap col-8 form-control d-flex flex-column align-items-center justify-content-center py-4">
            ...
            <div class="modal-footer">
                <a href="./sim-cl?tag=chrono" class="btn btn-secondary">Revenir</a>
                <button type="submit" class="btn btn-primary btn-send-pieces" name="btn-send-pieces">Envoyer les justificatifs</button>
              </div>
